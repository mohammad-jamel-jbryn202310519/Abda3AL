  ...
  return (
    <main className="container" style={{ padding: '4rem 1rem' }}>
      <div style={{ marginBottom: '3rem', textAlign: 'center' }}>
        <h1 className="text-gradient" style={{ fontSize: '3rem', marginBottom: '1rem' }}>شركة إبداع الخليج للخدمات الطلابية</h1>
        <p style={{ color: 'var(--text-secondary)', fontSize: '1.2rem' }}>للدراسة في أفضل الجامعات بكالوريوس - ماجستير - دكتوراه</p>
      </div>
      ...
      <div className="card" style={{ textAlign: 'center', maxWidth: '600px', margin: '0 auto', backgroundColor: 'rgba(99, 102, 241, 0.05)', border: '1px solid var(--accent-primary)' }}>
        <h3 className="text-gradient" style={{ fontSize: '1.8rem', marginBottom: '1rem' }}>وكيل معتمد لكافة الأوراق الرسمية</h3>
